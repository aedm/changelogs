...
pub mod get_commit_history {
    ...
    pub struct GetCommitHistoryRepositoryObjectOnCommitHistoryEdgesNodeParents {
        pub nodes: Option<
            Vec<Option<GetCommitHistoryRepositoryObjectOnCommitHistoryEdgesNodeParentsNodes>>,
        >,
    }
    #[derive(Deserialize, Debug)]
    pub struct GetCommitHistoryRepositoryObjectOnCommitHistoryEdgesNodeParentsNodes {
        pub oid: GitObjectID,
    }
}
